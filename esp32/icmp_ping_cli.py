# coding: utf-8
# ICMPでPingを送受信する(ATESAKI SHITEI) for ESP32 MicroPython
# Copyright (c) 2023 Wataru KUNINO

# ICMPでPingの送受信(ATESAKI SHITEI)を行います。
...
adr = ''                # set dist. IP address, KOKONI ATESAKI WO SETTEI SURU
                        # e.g. adr = '192.168.1.12', to the getway by default
...
if len(adr) == 0:
    adr = wlan.ifconfig()[2]					# send Ping to Gateway
